...
type MutablePhases = {
  ...
  shouldRebuildTotalMs?: number;
  renderPageTotalMs?: number;
  fileWriteTotalMs?: number;
  cacheEntryTotalMs?: number;
  searchIndexGenerationMs?: number;
  searchIndexWriteMs?: number;
  assetCopyMs?: number;
  cacheManifestSaveMs?: number;
  sitemapGenerationMs?: number;
  rssGenerationMs?: number;
  tailwindInitMs?: number;
  tailwindInventoryMs?: number;
  getDirectorySizeMs?: number;
